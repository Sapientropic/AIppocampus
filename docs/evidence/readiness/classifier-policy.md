...
| Provider conformance kit | #981 | Kit v1 implemented; live-host and broader ecosystem evidence stay bounded by #998, #1020, and #1021 | Clean-source integrations need a reusable conformance path before Beta can claim provider-facing reliability. The v1 kit covers provider-normalized ingestion and source-ref contracts, not live all-client quality. |
