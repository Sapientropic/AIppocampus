...
| Subconscious question/theme surfaces | `fixture_tested` | #248, #1059, [`question-tracking-subconscious.md`](../../architecture/question-tracking-subconscious.md) | Deterministic extraction, sidecar, parity, review-gated candidate flows, and selected-fixture six-axis threshold false-merge/false-split reporting exist. | Default live answer-quality lift, private-history dynamic-threshold calibration, or private-history generality. |
