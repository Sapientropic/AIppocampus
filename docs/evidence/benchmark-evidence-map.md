...
| Natural handoff usefulness validation | `docs/evidence/benchmarks/natural-handoff-usefulness-2026-06-14.md` | Bounded public/synthetic #1185/#1384 validation over natural handoff and default-session shapes. Records wins, no-help cases, and regressions through the canonical `continuity_usefulness` gate; not broad default-session product lift or private-history user-visible evidence. |
...
| STATE-Bench Agent Learning feasibility | `docs/evidence/benchmarks/state-bench-agent-learning.md`, `docs/evidence/benchmarks/reports/state-bench/state-bench-agent-learning-preflight-2026-06-10.json`, and `docs/evidence/benchmarks/state-bench-agent-learning-decision-2026-06-14.md` | Official source snapshot, train-only learning extraction boundary, read-only `retrieve_learnings` adapter scaffold, matched no-memory adapter/run-plan preflight, local ignored artifact policy, LF-checkout prompt-hash note, locked-eval-client blocker, and 2026-06-14 defer decision for #1043/#1379/#1381. No score/lift claim. |
...
| Natural handoff usefulness validation | `benchmarks/aippocampus/benchmark_natural_handoff_usefulness.py` | `docs/evidence/benchmarks/natural-handoff-usefulness-2026-06-14.md`, #1185, #1384 |
...
| LongMemEval retrieval-only benchmark and rerank analysis | `benchmarks/aippocampus/benchmark_longmemeval.py` and `benchmarks/aippocampus/benchmark_longmemeval_rerank_analysis.py` | `docs/evidence/benchmarks/longmemeval.md`, `docs/evidence/benchmarks/reports/longmemeval/longmemeval-semantic-rerank-analysis-2026-06-10.json`, `docs/evidence/benchmarks/reports/longmemeval/longmemeval-exact-line-repair-2026-06-12.json`, `docs/evidence/benchmarks/reports/longmemeval/longmemeval-semantic-cache-path-2026-06-12.json`, `docs/evidence/benchmarks/reports/longmemeval/longmemeval-semantic-cache-100q-2026-06-12.json`, `docs/evidence/benchmarks/reports/longmemeval/longmemeval-source-worker-surface-500q-2026-06-13.json`, `docs/evidence/benchmarks/reports/longmemeval/longmemeval-full-source-semantic-warming-500q-2026-06-13.json`, `docs/evidence/benchmarks/longmemeval-source-factual-alias-25-2026-06-14.md`, `docs/evidence/benchmarks/longmemeval-source-factual-alias-500-2026-06-14.md`, `docs/evidence/benchmarks/longmemeval-source-factual-alias-500-2026-06-14.json`, `benchmark_corpus/longmemeval_manifest.json`, #1092, #1193, #1305, #1323, #1327, #1387, #1388, #1424, #1425, #1426 |
