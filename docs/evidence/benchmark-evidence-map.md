...
| Dream real-history structural, public shadow, topology scout, and user-visible eval | `skills/aippocampus/scripts/aippocampus_runtime/dream/real_history_eval.py`, `skills/aippocampus/scripts/aippocampus_runtime/dream/public_shadow_report.py`, `skills/aippocampus/scripts/aippocampus_runtime/dream/topology_scout.py`, and `tests/aippocampus/test_dream_live_shadow_ab.py` | `docs/evidence/dream/dream-real-history-model-backed-eval-2026-05-31.md`, `docs/evidence/current-claims.md`, `docs/research/dream-task-design.md`, #163, #1268 |
