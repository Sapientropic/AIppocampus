...
| STATE-Bench Agent Learning feasibility and adapter scaffold | `benchmarks/aippocampus/benchmark_state_bench_agent_learning.py` | `docs/evidence/benchmarks/state-bench-agent-learning.md`, #1043 |
