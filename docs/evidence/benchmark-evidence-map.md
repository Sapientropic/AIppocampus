...
| Continuity density curve diagnostic | `benchmarks/aippocampus/benchmark_continuity_density_curve.py` and `tests/aippocampus/test_benchmark_continuity_density_curve.py` | Public-safe #1568 synthetic density tiers for cold/light/medium/heavy/noisy-saturated continuity payloads; measures enough-vs-too-much context pressure without private history, live agent behavior, default hook adoption, or release-quality user lift claims. |
...
| Continuity density curve diagnostic | `benchmarks/aippocampus/benchmark_continuity_density_curve.py` | #1568 |
