...
| AMemGym evidence | `docs/evidence/benchmarks/amemgym.md` and `benchmark_corpus/amemgym_manifest.json` | Official sources, public `v1.base` metadata smoke, source-backed overlay metrics, checked-in public fixture, and claim boundaries for #733. |
...
| Recall navigation comparison smoke | `docs/evidence/benchmarks/recall-navigation-comparison-2026-06-03.md` | Public-safe deterministic #465 comparison and narrow #201 route-actionability/source-reopen-follow-through proxy for direct `search_memory`, hook-only, and progressive `recall_context -> recall_deepen` arms; covers vague cues, multilingual cue fixtures, stale-handle rejection, and claim-boundary metrics without live or default-foreground-lift claims. |
...
| AMemGym metadata and source-backed overlay smoke | `benchmarks/aippocampus/benchmark_amemgym.py` | `docs/evidence/benchmarks/amemgym.md`, `benchmark_corpus/amemgym_manifest.json`, `benchmark_corpus/amemgym_fixture/fixture.json`, #733 |
