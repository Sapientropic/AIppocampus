...
| `longmemeval_s.retrieval_only_100_2026_06_09` | LongMemEval-S cleaned V1 retrieval-only larger slice: 100 questions; session R@10 97/100 = 0.9700; evidence-line R@10 82/94 = 0.8723; context-visible evidence R@10 91/94 = 0.9681; session MRR 0.8749, evidence-line MRR 0.6481, context-visible evidence MRR 0.8233; warning_count 0. | 2026-06-09 | [`longmemeval.md`, current published result](benchmarks/longmemeval.md#current-published-result) | `public_external_retrieval_only_slice` | LongMemEval-S cleaned V1 first 100 questions; deterministic retrieval-only adapter; top-k 10; evidence context radius 5; no QA generation or judge model. | Supersedes the 2026-05-30 50-question LongMemEval-S row for current LongMemEval-S retrieval-only sample size; oracle 50 remains a smoke row. | Answer-generation quality, LongMemEval QA score, judge-model score, LongMemEval-V2 score, SOTA or external baseline superiority, decision-gate quality, or broad memory superiority. |
...
- The LongMemEval-S 100-question row is the current larger retrieval-only
  external-benchmark slice. It supersedes the earlier 50-question
  LongMemEval-S row only for sample size and dated currentness, and it keeps
  answer generation, judge scoring, V2, SOTA comparison, and decision-gate
  claims out of scope.
