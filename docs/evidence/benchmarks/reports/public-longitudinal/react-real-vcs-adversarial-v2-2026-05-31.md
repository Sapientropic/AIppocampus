...
```powershell
python benchmarks\aippocampus\build_vcs_future_event_fixture.py --input .tmp\react-real-vcs-adversarial-v2\react-adversarial-v2-links.jsonl --output .tmp\react-real-vcs-adversarial-v2\react-adversarial-v2-fixture.jsonl --dataset-id react_real_vcs_adversarial_v2_2026_05_31 --license GitHub-public-metadata-local-report-only --source-family real_public_react_vcs_adversarial_v2 --allow-non-cc0-output --json
