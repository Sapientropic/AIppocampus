...
Status: deterministic public-safe calibration fixture for #375.
...
- Issue: <https://github.com/Sapientropic/AIppocampus/issues/375>
...
- GB-scale boundary: [`docs/architecture/gb-scale-roadmap.md`](../../architecture/gb-scale-roadmap.md)
...
and sentinel snippet text that the runner must not emit. The four required
patterns are:
...
Latest local result on 2026-06-03:
...
Decision: keep the current default weights. No policy values changed in this
slice.
