...
| Field/demo continuity | `benchmark_field_continuity.py` | public-safe magic-moment scenario contracts | implemented | P0/P1 | benchmark-smoke / full benchmark | contract_smoke | Demo overclaim, wrong-family route persistence | Live/private field quality proof | #454 |
...
| E2E50 | `benchmark_e2e50_silent_constraint.py` | silent-constraint scorer scaffold | scaffold | P0/P1 | benchmark-smoke support guard | contract_smoke | Scorer/report drift before representative cases exist | Closing #279 quality or 20/50-case result | #279 |
...
| Recall navigation | `smoke_recall_navigation_comparison.py` | implemented | P1 | focused smoke | public_safe_claim for deterministic proxy | Manual-query invention and route-follow-through regressions | Live #201 closure | #201, #465 |
