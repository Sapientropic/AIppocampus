...
| Attention router | `benchmark_attention_navigation_quality.py` | selected attention-router navigation and red-line fixtures across route, mask, stale/currentness, conflict, action-time, anti-nag, and evidence-packaging families | implemented | P1 | benchmark-smoke / direct runner | contract_smoke; #1195 public-cohort-candidate target recorded; `quality_gate_ok=false` until measured cohort, usefulness blockers, attention cost, holdout, and no-tuning-leak promotion pass | Navigation red-line drift and average-rate overclaim | Representative public route quality, answer generation, private-history quality, live host lift, or default foreground adoption | #1111, #1165, #1195 |
...
| E2E50 | `benchmark_e2e50_silent_constraint.py` | public-safe behavior pack for silent constraints, no-remember negatives, ordered sequence, and load sidecar contracts | contract_smoke | P0/P1 | benchmark-smoke support guard | contract_smoke; `quality_gate_ok=false` | Scorer/report drift, private case-count overblocking, order-insensitive route evidence, summary-overhang traps, and load overclaim | Representative #279 quality, #663 Episode/Arc layer, #575 load-routing quality, private-history lift, or 50-case result | #279/#663/#575/#1154 |
