...
| 2026-06-02 | Field-continuity reproducibility | [#454](https://github.com/Sapientropic/AIppocampus/issues/454) and [`benchmarks/field-continuity-fixture-report.md`](benchmarks/field-continuity-fixture-report.md) | Second-user reports gained a public fixture route without exposing raw history. |
...
| 2026-06-10 | Source-backed attention router and hard masks | [#1107](https://github.com/Sapientropic/AIppocampus/issues/1107) and [`docs/architecture/source-backed-attention-router.md`](../architecture/source-backed-attention-router.md) | Route packets stay navigation unless source scope and permissions allow more. |
...
| [`benchmarks/field-continuity-fixture-report.md`](benchmarks/field-continuity-fixture-report.md) | Public deterministic fixture | Reproducible field-continuity shapes derived from second-user reports. | Not broad live/private field quality. |
