...
| Cognitive runtime evidence | #163, #310, #313, #574, #575, #576, #663 | Keep open, but cut tightly. Existing substrate/report slices do not prove live/private or user-visible lift. Focus next PRs on Dream behavior evidence, Journey hint timing, thread-story / cognitive-portrait live probes, anticipatory prewarm ROI, private/live load calibration, private/live Observatory evidence, and Episode/Arc source reopen. |
