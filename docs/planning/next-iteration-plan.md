...
| Yi macro semantics hardening | #1389 | Keep open as a post-implementation semantics-hardening owner for Discussion #1210. The #1211-#1221 macro-orientation landing chain is closed; #1389 owns the remaining cross-grain contract, Three Powers ambiguity, change-line transition projection, and nuclear-basin engineering-exit questions through #1390-#1393. |
...
| Source-backed avatar illumination | #1407 | Keep open as a post-#1318 owner for source-backed avatar facets as posture/attention only, not persona overlays or fact authority. #1407 should turn the bounded-resonance research boundary into a runtime-safe illumination/activation contract before any foreground avatar packet is considered. |
...
| Benchmark and retrieval proof | #309, #1043, #1323, #1351 | Keep open as falsifiable evidence owners. Do not close with architecture prose. #309 uses #1370-#1372 for measured consumers, provider/language edges, and default score-fusion decisions. #1043 remains blocked on a matched no-memory STATE-Bench task run and uses #1379-#1381. #1323 uses #1327 and #1387-#1388 to separate LongMemEval proxy evidence from the intended source-side semantic/warm materializer; the 2026-06-13 full-source no-lift diagnosis also created #1424-#1426 for the missing factual/alias retrieval surface that basic source-backed fact queries need. #1351 owns Track D compaction-continuity design coverage and uses #1352-#1360. |
...
Current owner queue after the 2026-06-14 local issue/code/docs review should keep
#1407, #1389, #1351, #1323, #1188, #1185, #1043, #663, #576, #575, #309, #248, and #163.
#1394 and #1399 should move out of the active owner queue once their GitHub
children are closed or explicitly marked superseded by the current contracts.
Child issues are the execution queue; closed #279 is no longer a current owner.
