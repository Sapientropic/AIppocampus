...
| Usefulness and live route production | #1185, #1188 | Keep open as usefulness-first owner tracks. #1185 owns cross-surface usefulness blockers and uses #1382-#1384 for metrics, safe-but-useless fixtures, and natural/default-path validation. #1188 owns the live attention-router route-producer branch and uses #1347-#1350 plus #1385-#1386 for gate cleanup, public/holdout evidence, adoption, multilingual/deictic activation, and safe hint inputs. |
...
| Local/global compatibility hardening | #1394 | Keep open as a post-V0 hardening owner for Discussion #1270 and #1285. #1394 owns the remaining typed Section contract, restriction/time-window semantics, obstruction-cause taxonomy, useful-obstruction/false-glue adjudication metrics, Shi/Ying restriction-edge decision, and partial-glue narrowing protocol through #1395-#1398 and #1406. |
| Parallel derivation compatibility | #1399 | Keep open as a post-#1316 hardening owner for the missing cross-check between macro-derived navigation signals before downstream route/fanout flattening. #1399 owns source-basis/snapshot semantics, compatibility/degrade arbitration, the interlayer coupling surface, routing integration, #1316 regression fixtures, and derivation dependency DAG validation through #1400-#1405. |
...
Current owner queue after the 2026-06-13 issue-structure repair should keep
#1407, #1399, #1394, #1389, #1351, #1323, #1188, #1185, #1043, #663, #576, #575, #309, #248, and #163.
