...
| Cognitive runtime evidence | #163, #310, #313, #574, #575, #576, #663 | Keep open, but cut tightly. Existing substrate/report slices do not prove live/private or user-visible lift. Focus next PRs on Dream behavior evidence, Journey hint timing, thread-story / cognitive-portrait live probes, live/feedback-reviewed load calibration, private/live Observatory evidence, and Episode/Arc richer adapters / real-history adjudication. The #575 private-history aggregate runner now measures local clean-source load signals, but it still lacks reviewed false-positive/caution-usefulness and live host timing. The deterministic query-pattern route sidecar writer, prompt-hook scent consumer, and alias-free Observatory readout exist, but they still do not prove live DeepSeek alias quality or latency savings. The deterministic Episode/Arc packet-to-reopen navigation helper exists; packet routes still are not source evidence. |
