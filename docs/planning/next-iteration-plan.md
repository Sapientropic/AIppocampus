...
|---|---|---|
| Question continuity | #248 | Keep open, but narrowed. Extraction gates, prefilter reporting/parity, source-ref rejoin, fallback, selected answer-quality review plumbing, default borderline auto-materialization, stale-confirmation tolerance, question-blind structural baseline reporting, theme-resonance absence reporting, and a 2026-06-10 public/source-replayable shadow fixture now exist. The public shadow retires the immediate reproducibility gap for extraction/linking/source-reopen/negative-control cases, but it is not closeout. Execute the remaining work through native sub-issues #1367, #1368, and #1369. |
| Cognitive runtime evidence | #163, #575, #576, #663 | Keep open, but cut tightly. Existing substrate/report slices do not prove live/private or user-visible lift. Use the owner issue bodies and native sub-issues as the execution queue: #163 uses #1364-#1366, #575 uses #1373-#1375, #576 uses #1376-#1378, and #663 uses #1361-#1363. The #313 public structured-text closeout report remains useful evidence, but do not treat it as live/private quality or default recall lift. |
| Usefulness and live route production | #1185, #1188 | Keep open as usefulness-first owner tracks. #1384 now has a bounded public/synthetic natural-handoff/default-session validation artifact, but #1185 still owns broader default-path/live-host usefulness. #1188 owns the live attention-router route-producer branch and uses #1347-#1350 plus #1385-#1386 for gate cleanup, public/holdout evidence, adoption, multilingual/deictic activation, and safe hint inputs. |
...
| Benchmark and retrieval proof | #1043, #1323, #1424 | Keep open as falsifiable evidence owners. Do not close with architecture prose. #309 is no longer the active umbrella after `source-joined-routing-decision-2026-06-14.md`: #1370/#1372 can close and #309 can close as a decision issue, with text-first source-joined defaults retained and vector prefilter/local embedding adoption deferred. #1043 remains blocked on a matched no-memory STATE-Bench task run and uses #1379-#1381. #1323 uses #1327 and the LongMemEval source-window reports to separate proxy evidence from the intended source-side semantic/warm materializer. #1424 owns the broader factual/alias source-side recall gap after #1425/#1426 close their bounded materializer and hot-path evidence slices. Track D #1351 and children #1352-#1360 are closed. |
...
Current owner queue after the 2026-06-14 issue closeout should keep #1424,
#1323, #1188, #1185, #1043, #663, #576, #575, #248, and #163. #309, #1407,
#1389, #1351, #1394, #1399, and #1435 should move out of the active owner queue
once their GitHub issue-state closeout is confirmed. Child issues are the
execution queue; closed #279 is no longer a current owner.
