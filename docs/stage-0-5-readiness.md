...
- #66 adds a deterministic synthetic Track D runner for compaction-continuity
  measurement. This upgrades the benchmark surface, but it does not claim #65's
  real correction activation/outcome event pipeline, live hook capture, live
