...
| --- | --- | --- |
| 0 | `python -m unittest discover -s tests` passes 258 tests, docs health, hook installer tests, onboarding tests, Ruff `E9` + full Pyflakes `F`, and import-coupling guards for script cycles / hook import fan-out | Keep full suite green after each slice |
