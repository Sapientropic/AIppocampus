...
| `skills/aippocampus/scripts/semantic_recall_gate.py` | 860 | Semantic recall gating, candidate judgement, and evidence-aware suppression | Separate prompt construction/model response parsing from deterministic gate decisions if more providers are added. |
