...
- `aippocampus_runtime.sync.encrypted.admin` and `encrypted_sync_admin.py` compatibility path: `key|migrate-to-encrypted|cleanup-plaintext|migrate-object-to-encrypted|cleanup-object-plaintext`
