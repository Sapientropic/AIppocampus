...
| First release tag or explicit pre-release launch decision exists. | P0 | Not yet claimed. | `docs/guides/release-checklist.md`. |
| Public privacy scan and release checks are current for the launch commit. | P0 | Must be rerun before launch. | `docs/guides/privacy-security-checklist.md`. |
