...
| [#435 Attention Hint Before Action: mid-turn memory nudges for long agent loops](https://github.com/Sapientropic/AIppocampus/discussions/435) | route_attention | implemented_slice | [action-time hints](../architecture/coordination/action-time-hints.md) | #1670, #1671, #1799 | Keep hook/cache readiness explicit. | Ambient hints as always-on source truth. |
...
| [#523 Telepathy for Agent Clusters](https://github.com/Sapientropic/AIppocampus/discussions/523) | route_attention | implemented_slice | [Telepathy packets](../architecture/coordination/telepathy-coordination-packets.md) | #1686, #1747, #1758 | Keep coordination enums behind presets/cards. | Autonomous multi-agent consensus. |
...
| [#1591 Source-backed self-learning](https://github.com/Sapientropic/AIppocampus/discussions/1591) | learning_loop | implemented_slice | [action-time hints](../architecture/coordination/action-time-hints.md) | #1653, #1671, #1751 | Continue ledger-backed learning slices. | Learning loop improves every future task. |
