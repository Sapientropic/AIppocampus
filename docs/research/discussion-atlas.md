...
| [#2127 Moving Ground: source-backed memory and continuous craft](https://github.com/Sapientropic/AIppocampus/discussions/2127) | route_attention | active_design | [agent-native recall facade](../architecture/recall/agent-native-recall-facade.md) | #2489, #2490 | Keep a compact atlas pointer recallable; run `python tools/aippocampus/docs/discussion_atlas_guard.py --live-github --json` when atlas freshness is in doubt. | Discussion row as source truth or full article mirror. |
