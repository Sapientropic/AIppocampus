...
| [#700 Tacit memory as a source-backed narrative mesh](https://github.com/Sapientropic/AIppocampus/discussions/700) | topology_sequence | implemented_slice | [source-shape runtime spine](../architecture/source-shape-runtime-spine.md) / [source-backed recall discipline](../architecture/recall/source-backed-product-discipline.md) | APW source-shape fallback tests, APW promotion gate, Episode/Arc, Dream, topology tests | Use #2475 runtime issue chain; keep narrative mesh as design vocabulary unless a source-shape/pathlet owner contract says otherwise. | Narrative mesh as canonical truth or APW as default ranking. |
...
| [#2127 Moving Ground: source-backed memory and continuous craft](https://github.com/Sapientropic/AIppocampus/discussions/2127) | route_attention | active_design | [agent-native recall facade](../architecture/recall/agent-native-recall-facade.md) | #2489, #2490 | Keep a compact atlas pointer recallable for safe packet lost wording; run `python tools/aippocampus/docs/discussion_atlas_guard.py --live-github --json` when atlas freshness is in doubt. | Discussion row as source truth or full article mirror. |
