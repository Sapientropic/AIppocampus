...
| `tests/aippocampus/test_aippocampus_mcp_server.py` | 1787 | 1800 | #1450 / #1451 / #1656-#1676 / #1813 / #1817 / #1712 | Split JSON-RPC request builders or repeated MCP payload assertion helpers before adding another tool family; keep host-facing compact/full/error contracts visible together while the MCP surface stabilizes. The 2026-06-16 sweep kept required-any schema, recoverable last-recall, list-threads, memory-health recovery, and compact payload-budget assertions together because they guard one MCP host contract. `latest_reply` MCP closeout semantics now live in `tests/aippocampus/test_mcp_latest_reply.py`. |
| `tests/aippocampus/test_update_sync.py` | 1873 | 1900 | #1307 / #1335 / #1431 / #1563 / #1748 / #1755 / #1810 | Split Codex config/cache fixture builders or plugin apply/status assertion helpers before adding another host install/sync lane; keep one local-update contract suite until the marketplace/cache/current-thread visibility behavior stabilizes. The Windows hidden lifecycle launcher, plugin-cache smoke assertions, key-tool live host smoke, and host-conformance label tests stay here because they exercise the same local install/update contract; split host fixture builders before adding another platform lane. |
...
| `tests/aippocampus/test_aippocampus_health.py` | 1546 | 1620 | #248 / #1809 / #1782 | Split storage-pressure fixture builders or product-readiness projection assertions before adding another health lane; keep generated-cache pressure advisory and live-delta readiness together until that contract stabilizes. |
