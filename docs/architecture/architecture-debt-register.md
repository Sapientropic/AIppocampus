...
| `skills/aippocampus/scripts/dream_real_history_eval.py` | 707 | Selected real-history dream pack selection, deterministic compensatory/amplification worker, structural lift metrics, sanitized aggregate output, and CLI wiring | Split pack selection or surface-metric comparison into focused helpers before adding model-backed amplification, source-review sampling, or additional eval surfaces. |
