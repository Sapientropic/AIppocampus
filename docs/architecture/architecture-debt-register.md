...
| `tests/aippocampus/test_aippocampus_mcp_server.py` | 2145 | 2180 | #1450 / #1451 / #1656-#1676 / #1813 / #1817 / #1712 / #1889 / #1890 / #1982 / #2066-#2089 / #2013 | Split JSON-RPC request builders, source-window privacy fixtures, or repeated MCP payload assertion helpers before adding another tool family; keep host-facing compact/full/error contracts visible together while the MCP surface stabilizes. The 2026-06-17 sweep kept compact health-card defaults, recoverable agent-host action cards, source-window privacy/source-classification coverage, compact claim-boundary assertions, and AIppo no-task foreground-action contract coverage here because they guard one MCP host contract. `latest_reply` MCP closeout semantics now live in `tests/aippocampus/test_mcp_latest_reply.py`. |
...
| `tests/aippocampus/test_agent_opt_in_continuity.py` | 2191 | 2220 | #1507 / #1620 / #1808 / #1814 / #2069 / #2013 / #2021 | Split shared CLI/MCP fixture builders or returned-packet shape assertion helpers before adding another foreground recall surface; keep opt-in recall, AIppo, macro, compact/full recall boundary, and action-card JSON contracts visible together while the agent-facing packet shape is stabilizing. #2069 kept available-vs-global AIppo clause-count assertions here because they guard the same `agent aippo` JSON contract; #2013/#2021 keep canonical AIppo next-action and critique/audit task-family coverage in the same CLI surface owner. |
| `tests/aippocampus/test_aippocampus_cli.py` | 2126 | 2160 | #1756 / #1843 / #1838 / #1845 / #1774-#1823 / #2066-#2078 / #1986-#1996 / #2014-#2015 | Split subprocess runner helpers or command-family smoke tests into focused modules before adding more top-level facade, personal-control, learning, or package-facade cases; keep the first-five-minutes path visible in one smoke owner. Command-family recovery/help contracts live in `tests/aippocampus/test_cli_recovery_cards.py`; only facade-owned first-use smoke should stay here. The 2026-06-17 personal-control/self-note/work-guard assertions stay here only where the public facade itself owns routing. |
