...
| `tests/aippocampus/test_docs_health.py` | 1569 | 1580 | #672 / #1837 / #1845 / #1846 | Split public-doc command lint, executable memory-card examples, evidence-ledger guards, or product-profile guards into focused helpers before adding another docs-health domain; keep one repository health smoke owner for cross-doc drift. |
...
| `tools/aippocampus/docs/check_docs_health.py` | 1404 | 1420 | #672 | Product profile guards now live in `tools/aippocampus/docs/product_profile_guard.py`; evidence-ledger payload line checks stayed here because they are another repository docs-health invariant. Split another focused check group or shared markdown/path scanner before adding more public-readiness domains; keep single CLI output stable. |
