...
aippocampus agent explain --request 1 --recall-selector <emitted-selector> --json
...
[`packet-topology-diagnostics.md`](../coordination/packet-topology-diagnostics.md). They are an
...
MemoryPacket; see
[`packet-topology-diagnostics.md`](../coordination/packet-topology-diagnostics.md).
...
- Telepathy soft-lock and handoff-card packets live in
  [`telepathy-coordination-packets.md`](../coordination/telepathy-coordination-packets.md); this
...
- The hot/warm/cold source-reopen latency and timeout policy lives in
  [`source-reopen-budget.md`](../source/source-reopen-budget.md).
- The cross-agent read-path isolation hard negatives live in
  [`cross-agent-recall-isolation.md`](../coordination/cross-agent-recall-isolation.md).
