...
- the #531 corpus-style retrieval fixture:
  `docs/evidence/benchmarks/multimodal-corpus-fixture-report.md`;
- the #532 conversational media-ingest fixture:
  `docs/evidence/benchmarks/conversational-media-ingest-fixture-report.md`;
- the #533 supplied-pool/NIAH fixture:
  `docs/evidence/benchmarks/multimodal-niah-evidence-pool-report.md`;
- the #541 source manifest:
  `docs/architecture/multimodal-source-manifests.md`;
