...
- [`agent-native-recall-facade.md`](../recall/agent-native-recall-facade.md) owns the
...
- [`source-backed-attention-router.md`](../recall/source-backed-attention-router.md) owns
  route-packet authority and hard masks.
- [`foreground-memory-ux-budget.md`](../recall/foreground-memory-ux-budget.md) owns
