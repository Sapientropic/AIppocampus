...
| `aippocampus_runtime/sync/encrypted/bundle.py`, `aippocampus_runtime/sync/encrypted/admin.py`, `aippocampus_runtime/sync/encrypted/keys.py`, `aippocampus_runtime/sync/encrypted/migration.py`, `aippocampus_runtime/sync/encrypted/migration_recipients.py`, `aippocampus_runtime/sync/encrypted/migration_recovery.py`, `aippocampus_runtime/sync/encrypted/object_storage.py` | Age-backed encrypted sync overlay and plaintext migration helpers. | Public entrypoint |
