...
| `aippocampus_runtime/macro/hexagram.py`, `aippocampus_runtime/macro/signal_scales.py`, `aippocampus_runtime/macro/perturbation.py`, `aippocampus_runtime/macro/momentum.py`, `aippocampus_runtime/macro/line_topology.py`, `aippocampus_runtime/macro/state.py`, `aippocampus_runtime/macro/stage_tracker.py`, `aippocampus_runtime/macro/three_powers.py` | Deterministic hexagram substrate for macro-orientation experiments: exact King Wen lookup, bottom-to-top line convention, changing-line deltas, structural transforms, adjacency, shared macro signal-scale normalization/classification, distance bands, route-control perturbation amplitude, source-backed momentum phase compression, diagnostic-only line topology, project-scoped macro-orientation state validation/projection, King Wen project-stage movement tracking, Three Powers route facets for earth/human/heaven fanout, and structure-only public projection. It must not carry line texts, model calls, interpretive advice, or project-level fanout/state mutation from unpromoted Journey/thread signals; perturbation, momentum, line topology, Three Powers facets, and stage updates are navigation metadata and do not replace masks, action grammar, or source-backed authority. | Runtime internal |
...
| `aippocampus_runtime/warm_ambient/cli.py`, `aippocampus_runtime/warm_ambient/config.py`, `aippocampus_runtime/warm_ambient/prewarm_planner.py`, `aippocampus_runtime/warm_ambient/query_pattern_enrichment.py`, `aippocampus_runtime/warm_ambient/query_pattern_routes.py`, `aippocampus_runtime/warm_ambient/recall.py`, `aippocampus_runtime/warm_ambient/scheduler.py`, `aippocampus_runtime/warm_ambient/prompting.py`, `aippocampus_runtime/warm_ambient/scout_profiles.py`, `aippocampus_runtime/warm_ambient/scout_attribution.py`, `aippocampus_runtime/warm_ambient/source_validation.py`, `aippocampus_runtime/warm_ambient/diagnostics.py` | Warm ambient recall, no-write prewarm planning, registry/import query-pattern work planning, deterministic query-pattern route sidecar writes from registry metadata, hot-path scent packets, config, detached scheduling, scout taxonomy, attribution, and source validation. | Runtime internal |
