...
| `aippocampus_runtime/recall/active_recall.py`, `aippocampus_runtime/recall/active_recall_lock.py`, `aippocampus_runtime/recall/active_recall_lock_compaction.py`, `aippocampus_runtime/recall/active_path_packet.py`, `aippocampus_runtime/recall/narrative_packet.py`, `aippocampus_runtime/recall/route_notes.py`, `aippocampus_runtime/recall/ambient_cards.py`, `aippocampus_runtime/recall/ambient_cache.py`, `aippocampus_runtime/recall/ambient_cache_compaction.py`, `aippocampus_runtime/recall/ambient_policy.py` | Foreground active-recall, active-path orientation packets, task-time narrative route-packet projection, route-note sidecar projection, and ambient-card state, plus active-lock and ambient-cache dead-letter compaction as maintenance apply work. | Runtime internal |
...
| Active path and narrative orientation | `tests/aippocampus/test_active_path_packet.py`, `tests/aippocampus/test_narrative_packet.py` | Compact task-start path selection across existing recall/navigation surfaces, source-joined route notes, task-time narrative packets that merge pathlets/domain pointers/sequence packets/active routes/glyphs, route separation for scent/reopen/evidence/ignore, stale-boundary visibility, and ids-only source refs. |
