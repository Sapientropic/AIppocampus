...
| `aippocampus_runtime/dream/` | `dream_delivery_policy.py` | Hook-safe dream delivery mode parsing, rollout normalization, and foreground allow/holdback policy. |
