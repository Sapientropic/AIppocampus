...
| `aippocampus_runtime/source/semantic_scope_builder.py`, `aippocampus_runtime/source/semantic_scope_labels.py`, `aippocampus_runtime/source/semantic_scope_source_review_core.py`, `aippocampus_runtime/source/semantic_scope_suppressed_recovery.py` | Semantic sidecar materialization, validation, source review, and suppressed-label recovery. | Runtime internal |
...
| `aippocampus_runtime/sync/encrypted/bundle.py`, `aippocampus_runtime/sync/encrypted/admin.py`, `aippocampus_runtime/sync/encrypted/keys.py`, `aippocampus_runtime/sync/encrypted/migration.py`, `aippocampus_runtime/sync/encrypted/object_storage.py` | Age-backed encrypted sync overlay and plaintext migration helpers. | Public entrypoint |
