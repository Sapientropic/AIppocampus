...
| `aippocampus_runtime/dream/` | `dream_delivery_policy.py`, `dream_precision_policy.py`, `dream_worker_contract.py` | Hook-safe dream delivery policy, deterministic dream-hypothesis precision policies, and stable bounded-worker prompt contract. |
