...
| `aippocampus_runtime/knowledge/` | none | Deterministic knowledge-source manifest, claim-promotion, and append-only update-lifecycle validation for public-safe fixtures and future high-impact answer gates. It separates source eligibility, assertion-level promotion, review/signature, conflict, supersession/retraction, and rollback pointers without becoming a retrieval or ranking layer. |
