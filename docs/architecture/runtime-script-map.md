...
| `aippocampus_runtime/source/semantic_scope_builder.py`, `aippocampus_runtime/source/semantic_scope_labels.py`, `aippocampus_runtime/source/semantic_scope_evidence_diagnostics.py`, `aippocampus_runtime/source/semantic_scope_source_review_core.py`, `aippocampus_runtime/source/semantic_scope_suppressed_recovery.py`, `aippocampus_runtime/source/source_texture.py`, `aippocampus_runtime/source/texture_consumption.py`, `aippocampus_runtime/source/agent_self_notes.py`, `aippocampus_runtime/source/agent_self_note_cli.py` | Semantic sidecar materialization, validation, public-safe evidence diagnostics, source review, suppressed-label recovery, deterministic source-texture rows, shared sanitized consumer projection for Dream/Journey/correction routing, private low-authority foreground-agent self-note sidecars, and the public current-thread self-note append facade. | Runtime internal |
