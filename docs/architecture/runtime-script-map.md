...
| `aippocampus_runtime/knowledge/` | none | Deterministic knowledge-source manifest and claim-promotion schema validation for public-safe fixtures and future high-impact answer gates. It separates source eligibility, assertion-level promotion, review/signature, conflict, and supersession checks without becoming a retrieval or ranking layer. |
