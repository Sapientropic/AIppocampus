...
| `aippocampus_runtime/subconscious/` | `subconscious_deterministic_jobs.py`, `subconscious_job_circuits.py`, `subconscious_job_plan.py`, `subconscious_job_storage.py`, `subconscious_job_validation.py`, `subconscious_jobs_config.py`, `subconscious_question_diagnostics.py`, `subconscious_validation_audit.py` | Deterministic follow-up dispatch, job circuit/schema contracts, sample-wave planning, append-only job-finding storage, finding validation, run configuration/default-path helpers, question-extraction diagnostics, and validation diagnostics used by subconscious job runners. |
...
| `subconscious_runtime.py`, `subconscious_agent.py`, `subconscious_tool_loop.py`, `aippocampus_runtime/subconscious/{deterministic_jobs,job_circuits,job_plan,job_storage,job_validation,jobs_config,question_diagnostics,validation_audit}.py` plus `subconscious_deterministic_jobs.py` / `subconscious_job_circuits.py` / `subconscious_job_plan.py` / `subconscious_job_storage.py` / `subconscious_job_validation.py` / `subconscious_jobs_config.py` / `subconscious_question_diagnostics.py` / `subconscious_validation_audit.py` compatibility shims | Runtime loops, tool execution, deterministic follow-up dispatch, job circuit/schema contracts, sample-wave planning, append-only finding storage, finding validation, job-run configuration, question-extraction diagnostics, and non-text validation diagnostics for background agents/jobs. | Scheduler/worker internals. | Job config, external model client, registry outputs. | Runtime internal |
