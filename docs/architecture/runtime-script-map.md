...
| `aippocampus_runtime/recall/prompt_recall_hot_path.py`, `aippocampus_runtime/recall/prompt_recall_hot_path_debug.py`, `aippocampus_runtime/recall/prompt_recall_route_context.py`, `aippocampus_runtime/recall/prompt_recall_channels.py`, `aippocampus_runtime/recall/prompt_context_render.py` | Foreground prompt route preparation, local hot-path scent stages, fast/deep channel diagnostics, public-safe hot-path debug projection, and hook context rendering. | Runtime internal |
