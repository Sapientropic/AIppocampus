...
| `aippocampus_runtime/reflection/space.py`, `aippocampus_runtime/reflection/reconsolidation.py`, `aippocampus_runtime/reflection/host_capture.py` | Reflection-space topology, correction reconsolidation, opt-in source-ref-gated host-event capture, and aggregate-only correction adjudication buckets. | Runtime internal |
