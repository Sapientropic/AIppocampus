...
| `aippocampus_runtime/source/semantic_scope_builder.py`, `aippocampus_runtime/source/semantic_scope_labels.py`, `aippocampus_runtime/source/semantic_scope_evidence_diagnostics.py`, `aippocampus_runtime/source/semantic_scope_source_review_core.py`, `aippocampus_runtime/source/semantic_scope_suppressed_recovery.py`, `aippocampus_runtime/source/source_texture.py`, `aippocampus_runtime/source/texture_consumption.py` | Semantic sidecar materialization, validation, public-safe evidence diagnostics, source review, suppressed-label recovery, deterministic source-texture rows, and the shared sanitized consumer projection for Dream/Journey/correction routing. | Runtime internal |
