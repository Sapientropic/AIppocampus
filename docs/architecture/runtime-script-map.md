...
| `aippocampus_runtime/dream/` | `dream_delivery_policy.py`, `dream_one_sidedness.py`, `dream_precision_policy.py`, `dream_worker_contract.py` | Hook-safe dream delivery policy, deterministic one-sidedness gating, deterministic dream-hypothesis precision policies, and stable bounded-worker prompt contract. |
