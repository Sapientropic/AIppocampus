...
| `aippocampus_runtime/reflection/space.py`, `aippocampus_runtime/reflection/reconsolidation.py`, `aippocampus_runtime/reflection/host_capture.py`, `aippocampus_runtime/reflection/retrieval_lifecycle.py`, `aippocampus_runtime/reflection/consolidation_priority.py` | Reflection-space topology, correction reconsolidation, opt-in source-ref-gated host-event capture, aggregate-only correction adjudication buckets, append-only retrieval lifecycle diagnostics for future general reconsolidation consumers, and fixture-tested consolidation-priority event rows for later review ordering. | Runtime internal |
