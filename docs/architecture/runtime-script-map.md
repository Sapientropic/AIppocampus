...
| `aippocampus_runtime/coding/` | `coding_ticket_host_contract.py` | Host consumption contract and simulator for source-backed coding-continuity tickets. |
