...
[Agent Skill Capability Contracts](../host/agent-skill-capability-contracts.md). Those
...
defined in
[Question Tracking as a Subconscious Layer](../recall/question-tracking-subconscious.md#summary-hippocampal-mechanisms--aippocampus-design)
