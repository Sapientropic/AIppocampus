...
Role: runtime-envelope contract index.
Status: current architecture layer.

Use this folder for runtime-wide shape, field projection policy, and future core
runtime direction. Concrete script ownership remains in
[`../runtime-script-map.md`](../runtime-script-map.md).
