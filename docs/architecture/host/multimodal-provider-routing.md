...
`docs/architecture/host/agent-skill-capability-contracts.md` and the source/origin
policy from `docs/architecture/source/multimodal-source-manifests.md`.
...
`docs/architecture/host/multimodal-answer-gate.md`. Provider routing decides whether
