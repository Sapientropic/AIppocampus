...
This file keeps the active browser companion design surface. Dated platform
checks, competitor notes, internal endpoint observations, and reference
project lists live in [`browser-extension-research-notes.md`](browser-extension-research-notes.md).

## 0. 平台复核快照（2026-05-30）

Moved background notes: [`browser-extension-research-notes.md#0-平台复核快照2026-05-30`](browser-extension-research-notes.md#0-平台复核快照2026-05-30).

## 1. 缘起

Moved background notes: [`browser-extension-research-notes.md#1-缘起`](browser-extension-research-notes.md#1-缘起).

## 2. 竞品地图（调研草稿，待源核验）

Moved background notes: [`browser-extension-research-notes.md#2-竞品地图调研草稿待源核验`](browser-extension-research-notes.md#2-竞品地图调研草稿待源核验).
...
Moved background notes: [`browser-extension-research-notes.md#6-claudeai-技术细节备忘待实测复核`](browser-extension-research-notes.md#6-claudeai-技术细节备忘待实测复核).
...
Moved background notes: [`browser-extension-research-notes.md#10-chatgpt-拦截可行性修正调研假设待源核验`](browser-extension-research-notes.md#10-chatgpt-拦截可行性修正调研假设待源核验).

## 11. 参考项目（深入研究用）

Moved background notes: [`browser-extension-research-notes.md#11-参考项目深入研究用`](browser-extension-research-notes.md#11-参考项目深入研究用).
