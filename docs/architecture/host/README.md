# Host And Provider Architecture

Role: host, provider, and product-surface contract index.
Status: current architecture layer.

Use this folder when a change touches host integrations, capability boundaries,
provider routing, product profiles, multimodal answer gates, or high-risk answer
surfaces.
...
| [product-profiles.md](product-profiles.md) | Personal default, power-user optional, and enterprise-governed profiles. |
| [provider-entrypoint-inventory.md](provider-entrypoint-inventory.md) | Provider-aware and Codex-specific entrypoint ownership. |
