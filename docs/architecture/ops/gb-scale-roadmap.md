...
- `aippocampus storage gc --dry-run` starts the storage governance bridge: it
  ...
  `docs/architecture/future/rust-deterministic-core.md`.
...
4. Add cross-segment top-k merge. Done: first diversity-aware merge in
   ...
   [`docs/evidence/benchmarks/reports/fresh-thread/segmented-merge-policy-fixture-report.md`](../../evidence/benchmarks/reports/fresh-thread/segmented-merge-policy-fixture-report.md).
