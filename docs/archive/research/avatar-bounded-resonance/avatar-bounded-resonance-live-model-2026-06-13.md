...
Role: archived exploratory public-safe live-model report for #1321.
...
python benchmarks/aippocampus/benchmark_avatar_bounded_resonance.py --mode live-model --output docs/archive/research/avatar-bounded-resonance/avatar-bounded-resonance-live-model-2026-06-13.json --json
```
