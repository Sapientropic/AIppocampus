...
Role: archived public-safe label-oracle diagnostic for #1322.

Current owner: `docs/evidence/current-claims.md` carries the present claim
boundary; `docs/research/reports/e2e50-blind-surface-live-behavior-2026-06-13.md`
carries the corrected public behavior slice.
...
```powershell
$env:PYTHONPATH='skills/aippocampus/scripts'; python benchmarks/aippocampus/benchmark_e2e50_behavior_live.py --prompt-mode label-oracle --output docs/archive/research/e2e50/e2e50-live-behavior-pilot-2026-06-13.json --json
```
