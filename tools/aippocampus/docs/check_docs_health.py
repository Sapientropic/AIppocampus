...
from benchmark_evidence_guard import (
    REQUIRED_BENCHMARK_EVIDENCE_MAP_TERMS as REQUIRED_BENCHMARK_EVIDENCE_MAP_TERMS,
)
from benchmark_evidence_guard import (
    benchmark_evidence_entrypoints as benchmark_evidence_entrypoints,
)
from benchmark_evidence_guard import benchmark_evidence_map_issues
...
SAFE_ENV_ALLOWED_VALUES = {
    "AIPPOCAMPUS_PROMPT_HOOK_BUDGET_MS": "3500",
    "AIPPOCAMPUS_LIFECYCLE_HOOK_BUDGET_MS": "15000",
    "AIPPOCAMPUS_PROMPT_SKIP_TELEMETRY": "1",
    "AIPPOCAMPUS_SEMANTIC_GATE": "auto",
    "AIPPOCAMPUS_SUBCONSCIOUS_HOOK": "off",
    "AIPPOCAMPUS_BACKGROUND_MODEL_CONSENT": "off",
}
