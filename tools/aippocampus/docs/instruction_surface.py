...
try:
    from tools.aippocampus.docs.instruction_surface_owner_registry import (
        INSTRUCTION_SURFACE_CLASSIFIED_FILES,
    )
except ModuleNotFoundError:
    from instruction_surface_owner_registry import INSTRUCTION_SURFACE_CLASSIFIED_FILES
