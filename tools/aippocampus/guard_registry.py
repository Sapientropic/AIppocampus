...
COMPACT_FIELD_CLASSIFICATIONS: dict[str, str] = {
    ...
    "category_summary": "compact_contract",
    "category_summary_truncated": "compact_contract",
    "input_source": "compact_contract",
    ...
    "manual_required_count": "compact_contract",
    "manual_required_claim_count": "compact_contract",
    "first_manual_required_claim": "compact_contract",
    "manual_required_claims": "compact_contract",
    "top_actionable_queue": "compact_contract",
    ...
    "command_preview": "compact_contract",
    "command_truncated": "compact_contract",
