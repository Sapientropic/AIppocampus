...
class IssueWorkGuardTests(unittest.TestCase):
    def test_benchmark_source_side_issue_requires_active_pull_before_manual_search(self) -> None:
        ...
        self.assertEqual(packet["foreground_action_contract"], "foreground-action-v2")
        self.assertNotIn("agent_next_action", packet)
        self.assertNotIn(packet["foreground_action"], packet["safe_next_actions"])
