...
class ForegroundActionCardTests(unittest.TestCase):
    ...
    def test_compact_health_separates_workspace_maintenance_from_recall_availability(self) -> None:
        ...
        self.assertNotIn("claim_boundary", compact["foreground_action"])
        self.assertIn("Continue", compact["foreground_action"]["label"])
        self.assertTrue(compact["blocks_exact_latest_claims"])
        ...
        self.assertTrue(compact["readiness_card"]["blocks_exact_latest"])
