...
def fixture_rows() -> list[dict[str, object]]:
    return [
        ...
        },
        {
            ...
            "route": {
                "docs": ["docs/architecture/compatibility-shim-inventory.md"],
                "tests": ["tests/aippocampus/test_compat_shim_inventory.py"],
            },
            "source_refs": [{"path": "docs/architecture/compatibility-shim-inventory.md", "line": 1}],
            "freshness": "current",
            "invalidation": {"files": [{"path": "docs/architecture/compatibility-shim-inventory.md", "sha256": "hash-shim"}]},
            ...
            "first_source_to_reopen": "docs/architecture/compatibility-shim-inventory.md",
        ...
        },
        {
            ...
            "source_refs": [{"path": "docs/architecture/gb-scale-roadmap.md", "line": 90}],
            "freshness": "current",
    ...
    def test_selector_caps_packet_and_reports_only_deterministic_cost_proxy(self) -> None:
        ...
        packet = repo_familiarity.select_repo_familiarity_packet(
            ...
            current_fingerprints={
                ...
                "docs/architecture/cognitive-runtime-architecture.md": "hash-architecture",
            },
