...
from aippocampus_runtime.registry.import_usage import (
    maybe_handle_import_conversation_usage,
    render_import_conversation_error,
)
    ...
    entry = {
        ...
        **project,
        ...
        "paths": {
            ...
            "clean_source_route_notes_jsonl": (clean_manifest.get("outputs") or {}).get(
                "route_notes_jsonl"
            ),
            "clean_source_texture_jsonl": (clean_manifest.get("outputs") or {}).get(
                "source_texture_jsonl"
            ),
...
def main(argv: list[str] | None = None) -> int:
    ...
    public_import_conversation = "register-source" in raw_args
