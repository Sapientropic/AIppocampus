    ...
    entry = {
        ...
        **project_meta,
        ...
        "paths": {
            ...
            "clean_source_events_jsonl": clean_outputs.get("events_jsonl"),
            "clean_source_route_notes_jsonl": clean_outputs.get("route_notes_jsonl"),
            "clean_source_texture_jsonl": clean_outputs.get("source_texture_jsonl"),
