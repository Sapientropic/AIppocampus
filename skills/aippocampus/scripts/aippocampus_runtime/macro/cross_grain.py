...
def macro_transition_record(
    ...
    *,
    ...
    return {
        ...
        "changed_line_layers": packet.get("changed_line_layers") or [],
        "changed_layer_counts": packet.get("changed_layer_counts") or {},
        "dominant_changed_layer": packet.get("dominant_changed_layer") or "none",
