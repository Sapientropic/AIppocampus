...
_REASON_ROWS = (
    ...
    (
        ...
        "suppressed",
        "ambient_cache",
        "A privacy guard blocked unredacted external payload projection.",
    ),
    (
        "secret_or_property_risk_blocked",
        "suppressed",
        "ambient_cache",
        "A privacy guard blocked secret-like or property-risk material.",
    ),
    (
        "local_route_handle_only",
        "surfaced",
        "ambient_cache",
        "The privacy guard kept same-user continuity as a local route handle.",
    ),
    (
    ...
    (
        ...
        "surfaced",
        "ambient_cache",
        "A bounded source-backed evidence card is ready for relevant use.",
    ),
    (
        "reopen_recommended_for_exact_quote",
        "surfaced",
        "ambient_cache",
        "The evidence is usable, but exact quotes or wider context should reopen source.",
    ),
    (
        "reopen_required_before_claim",
        "surfaced",
        "ambient_cache",
        "The surface is still a handle and needs source reopen before a claim.",
    ),
...
NEXT_ACTION_BY_REASON = {
    ...
    "external_payload_blocked": "ask_user_or_narrow_scope",
    "secret_or_property_risk_blocked": "ask_user_or_narrow_scope",
    "local_route_handle_only": "reopen_source",
    ...
    "reopen_required_before_claim": "reopen_source",
    "bounded_evidence_ready": "use_bounded_evidence_when_relevant",
    "reopen_recommended_for_exact_quote": "use_evidence_reopen_for_exact_quote",
